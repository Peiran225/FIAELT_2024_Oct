...
# GLOBAL PARAMETERS
OPTIMIZERS = ['fedavg', 'fedadmm', 'feddr', 'fedpd', 'fiaelt']
DATASETS = ['FEMNIST', 'synthetic_iid', 'synthetic_0_0', 'synthetic_0.5_0.5', 'synthetic_1_1', 'celeba']
...
def read_options():
    ...
    parser.add_argument('--local_optim', help='local optimizer', type=str, default='pgd')
    parser.add_argument('--term_alpha', help='termination criterion', type=float, default=0.1)
