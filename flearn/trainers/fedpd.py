...
class Server(object):
    def __init__(self, params, learner, dataset):
        ...
        if params['local_optim'] == "pgd":
            ...
            self.inner_opt_list = [SVRG(params['learning_rate']) for _ in range(num_clients+1)]
        elif params['local_optim'] == "gd":
            self.inner_opt_list = [tf.train.GradientDescentOptimizer(params['learning_rate']) for _ in range(num_clients+1)]
    ...
    def train(self):
        ...
        for i in range(self.num_rounds):
            ...
            for idx, c in enumerate(selected_clients.tolist()):
                ...
                soln, stats, iterations = c.solve_inner_dr(num_epochs=self.num_epochs, batch_size=self.batch_size,
